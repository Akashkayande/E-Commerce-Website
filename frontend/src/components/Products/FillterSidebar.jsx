        ...
        <div className="mb-6">
            ...
            {categories.map((category)=>(
                <div key={category} className='flex items-center mb-1 cursor-pointer'>
                    <input type="radio" name='category' value={category} onChange={handleFilterChange} checked={filters.category === category} className='mr-2 h-4 w-4 ' />
        ...
        <div className="mb-6">
            ...
            {genders.map((gender)=>(
                <div key={gender} className='flex items-center mb-1 cursor-pointer'>
                    <input type="radio" name='gender' value={gender} onChange={handleFilterChange} checked={filters.gender === gender} className='mr-2 h-4 w-4 ' />
        ...
        <div className="mb-6">
            ...
            {sizes.map((size)=>(
                <div key={size} className='flex items-center mb-1 cursor-pointer'>
                    <input type="checkbox" name='size' value={size} onChange={handleFilterChange} checked={filters.size.includes(size)} className='mr-2 h-4 w-4 cursor-pointer ' />
        ...
        <div className="mb-6">
            ...
            {materials.map((material)=>(
                <div key={material} className='flex items-center mb-1 cursor-pointer'>
                    <input type="checkbox" name='material' value={material} onChange={handleFilterChange} checked={filters.material.includes(material)} className='mr-2 h-4 w-4 ' />
        ...
        <div className="mb-6">
            ...
            {brands.map((brand)=>(
                <div key={brand} className='flex items-center mb-1 cursor-pointer'>
                    <input type="checkbox" name='brand' value={brand} onChange={handleFilterChange} checked={filters.brand.includes(brand)} className='mr-2 h-4 w-4 cursor-pointer' />
            ...
            <div className="mb-8">
                ...
                <div className="flex justify-between text-gray-600 mt-2"><span>$0</span> <span>${priceRange[1]}</span></div>
            </div>
